...
c..spherical constant density should reach r=1 at t=1
      ...
      gamma  = 1.6666666666666666666666666666666666666666q0
      nstep = 3600
      eblast = 1.25q05
      xgeom  = 3.0q0
      omega  = 0.0q0
...
c..input parameters in cgs
      ...
      vel0   = 0.0q0
      pres0  = 0.00001
      ener0  = 5.2083333333333333333333333333333333333333q-09
...
c..output file 
      ...
      do i=0,nstep
       write(2,04) zpos(i),den(i),pres(i),vel(i)
      enddo
      close(unit=2)
