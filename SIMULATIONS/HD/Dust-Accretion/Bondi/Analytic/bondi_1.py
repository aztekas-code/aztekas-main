...
#######################################################
#
# Compare Bondi analytic solution for gamma = 1
...
plt.savefig('bondi_1_velocity.png', bbox_inches='tight', pad_inches=0.0,dpi=200)
...
plt.savefig('bondi_1_density.png', bbox_inches='tight', pad_inches=0.0,dpi=200)
